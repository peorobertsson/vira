...
def main(vira, *, issue_key: str, new_parent_issue_key: str):
    ...
    vira.add_child_issue_to_parent(parent_issue=new_parent_issue, child_issue=issue)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-s", "--src_issue", required=True, help="The issue to copy from"
    )
    parser.add_argument(
        "-p",
        "--parent_issue",
    ...
    main(vira, issue_key=g_args.src_issue, new_parent_issue_key=g_args.parent_issue)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--issue", required=True, help="The issue")
    parser.add_argument(
        "--parent",
        required=True,
    ...
    main(vira, issue_key=g_args.issue, new_parent_issue_key=g_args.parent)
